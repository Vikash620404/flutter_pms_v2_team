...
class ModuleDetailsPrndingScreen extends StatefulWidget {
  const ModuleDetailsPrndingScreen({super.key});

  @override
  State<ModuleDetailsPrndingScreen> createState() => _ModuleDetailsPrndingScreenState();
}

class _ModuleDetailsPrndingScreenState extends State<ModuleDetailsPrndingScreen> {
  @override
          ...
          child: Column(
            children: [
              GestureDetector(
                  ...
                  child: CustomRowWidget(labelText: "Client Module")),
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => const MilestoneListScreen()),
                                );
                              },
                              child: const Text(
                                'View All',
