...
class TaskCompletedDetailsScreen extends StatefulWidget {
  const TaskCompletedDetailsScreen({Key? key}) : super(key: key);

  @override
  State<TaskCompletedDetailsScreen> createState() => _TaskCompletedDetailsScreenState();
}

class _TaskCompletedDetailsScreenState extends State<TaskCompletedDetailsScreen> {
  bool? showList;
            ...
            child: Column(
              ...
              children: [
                GestureDetector(
                    ...
                    child: const HeaderWidget2(text1: "Task Details")),
                const SizedBox(
                  height: 40,
                ),
                const TaskStatus(
