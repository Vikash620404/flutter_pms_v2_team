...
class SegmentedControlMilestoneList extends StatefulWidget {
  const SegmentedControlMilestoneList({Key? key}) : super(key: key);

  @override
  State<SegmentedControlMilestoneList> createState() =>
      _SegmentedControlMilestoneListState();
}

class _SegmentedControlMilestoneListState
    extends State<SegmentedControlMilestoneList> {
        ...
        children: [
          ...
          if (selectedIndex == 2) ...[
            const SegmentedButtonShowCard(
              ...
              flagImage: 'assets/images/task-square.png',
              mileText: '120 Task',
              webText: 'Due in 10 days',
              dotImage: 'assets/images/dotImage.png',
              webTextStyle: TextStyle(color: Colors.red), onPressed: null, // Add this line to change the color to red
            )
