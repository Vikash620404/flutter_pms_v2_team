...
import '../../version_detail_pending/screen/version_detail_pending_screen.dart';

class SegemntedControlVersionList extends StatefulWidget {
  const SegemntedControlVersionList({Key? key}) : super(key: key);

  @override
  State<SegemntedControlVersionList> createState() =>
      _SegemntedControlVersionListState();
}

class _SegemntedControlVersionListState
    extends State<SegemntedControlVersionList> {
